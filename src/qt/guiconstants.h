...
/* DON GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "DON"
#define QAPP_ORG_DOMAIN "don.org"
#define QAPP_APP_NAME_DEFAULT "DON-Qt"
#define QAPP_APP_NAME_TESTNET "DON-Qt-testnet"
