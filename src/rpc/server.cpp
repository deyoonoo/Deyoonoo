...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DON features */
        {"don", "masternode", &masternode, true, true, false},
        {"don", "listmasternodes", &listmasternodes, true, true, false},
        {"don", "getmasternodecount", &getmasternodecount, true, true, false},
        {"don", "masternodeconnect", &masternodeconnect, true, true, false},
        {"don", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"don", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"don", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"don", "masternodecurrent", &masternodecurrent, true, true, false},
        {"don", "masternodedebug", &masternodedebug, true, true, false},
        {"don", "startmasternode", &startmasternode, true, true, false},
        {"don", "createmasternodekey", &createmasternodekey, true, true, false},
        {"don", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"don", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"don", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"don", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"don", "getmasternodescores", &getmasternodescores, true, true, false},
        {"don", "mnbudget", &mnbudget, true, true, false},
        {"don", "preparebudget", &preparebudget, true, true, false},
        {"don", "submitbudget", &submitbudget, true, true, false},
        {"don", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"don", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"don", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"don", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"don", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"don", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"don", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"don", "checkbudgets", &checkbudgets, true, true, false},
        {"don", "mnsync", &mnsync, true, true, false},
        {"don", "spork", &spork, true, true, false},
        {"don", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> don-cli " + methodname + " " + args + "\n";
}
