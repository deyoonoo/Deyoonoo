...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 16889;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // DON starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // DON: 1 day
        nTargetSpacing = 1 * 60;  // DON: 1 minute
        nMaturity = 30;
	    ...
	    vSeeds.push_back(CDNSSeedData("dnsseed.deyoonoocoin.io", "dnsseed.deyoonoocoin.io"));
        ...
        nZerocoinRequiredStakeDepth = 100; //The required confirmations for a zdon to be stakable
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // DON: 1 day
        nTargetSpacing = 1 * 60;        // DON: 1 minutes
