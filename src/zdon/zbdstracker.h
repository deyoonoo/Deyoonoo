...
#ifndef DON_ZDONTRACKER_H
#define DON_ZDONTRACKER_H
...
public:
    ...
    ~CzDONTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzDONWallet* zDONWallet = NULL);
