...
RESOURCES += src/qt/don.qrc src/qt/don_locale.qrc

TRANSLATIONS += src/qt/locale/don_bg.ts \
                src/qt/locale/don_de.ts \
                src/qt/locale/don_en.ts \
                src/qt/locale/don_es.ts \
                src/qt/locale/don_fi.ts \
                src/qt/locale/don_fr.ts \
                src/qt/locale/don_it.ts \
                src/qt/locale/don_ja.ts \
                src/qt/locale/don_pl.ts \
                src/qt/locale/don_pt.ts \
                src/qt/locale/don_ru.ts \
                src/qt/locale/don_sk.ts \
                src/qt/locale/don_sv.ts \
                src/qt/locale/don_vi.ts \
                src/qt/locale/don_zh_CN.ts \
                src/qt/locale/don_zh_TW.ts
