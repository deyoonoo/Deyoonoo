Contributing to DON Core
============================

The DON Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DON Core project, and is not to be
confused with overall DON Network Protocol consensus changes.

Whether a pull request is merged into DON Core rests with the project merge
...
Patches that change DON consensus rules are considerably more involved than
...
Where a patch set proposes to change the DON consensus, it must have been
...
The project leader is the release manager for each DON Core release.
