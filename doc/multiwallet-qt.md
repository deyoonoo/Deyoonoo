...
In order to support loading of multiple wallets in don-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is don.cpp.
...
Changes to don.cpp
----------------------
don.cpp is the entry point into don-qt, and as such, will require some minor modifications to provide hooks for
