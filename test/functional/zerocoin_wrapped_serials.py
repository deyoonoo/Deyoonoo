...
from fake_stake.base_test import DON_FakeStakeTest

class zDONwrappedSerialsTest(DON_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zDONs..." % DENOM_TO_USE)
